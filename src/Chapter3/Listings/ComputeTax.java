...
//The program receives the filing status and taxable income. The multi-way if-else statements (lines 22, 42, 45, 48, and 51) check the filing status and compute the tax based on the
//filing status.
